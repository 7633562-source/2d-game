...
You are the **2D level generation** profile agent. Project documents are
English only. Chat with Yury stays Russian.
...
generator on `SampleScene`, `Bird`, or `BirdFlock50`. World keeps
`birdCount = 0`.
